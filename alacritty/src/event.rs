        ...
        match event {
            ...
            WinitEvent::WindowEvent { event, .. } => {
                match event {
                    ...
                    WindowEvent::PointerButton { state, button, position, .. } => match button {
